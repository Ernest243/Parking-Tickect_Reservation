    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="./views/choice_user.php">Rent a car</a>
          <a class="dropdown-item" href="./views/choice_user.php">Reserve a parking</a>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-12 mb-3 text-center center">
      ...
      <input type="number" name="" value="" class="form-control" style="width: 50%; margin: 0 auto;">
    </div>
  </div>

  <div class="col-md-12 mb-3 text-center center">
    <button type="button" name="" value="" class="btn btn-primary btn-lg">Check availability</button>
  </div>
</div>
</div>
